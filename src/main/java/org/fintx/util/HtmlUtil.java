...
public class HtmlUtil {
    ...
    public static void main(String[] args) {
        ...
        ScriptResult s=page.executeJavaScript("var CookieCsiiNetBank = new Cookie(document, \"promoteFlag\", 24*365*10);CookieCsiiNetBank.load();document.form2.submit();");
        webClient.waitForBackgroundJavaScript(60*1000); 
        webClient.setJavaScriptTimeout(-1L);
        ...
        ScriptResult s1=page.executeJavaScript("var pwdShowMsg=document.getElementById(\"pwdShowMsg\"); var newInput = document.createElement(\"input\");newInput.type=\"hidden\";  newInput.name=\"Password\"; newInput.id=\"Password\";newInput.value=\"888888\";pwdShowMsg.appendChild(newInput); ");
        webClient.waitForBackgroundJavaScript(60*1000); 
        webClient.setJavaScriptTimeout(-1L);
