...
public final class HttpClientBase {
    ...
    public String get(URL url) throws IOException, IllegalStateException {
        if (null == url) {
    ...
    public InputStream getFile(URL url) throws IOException, IllegalStateException {
        if (null == url) {
            throw new NullPointerException("url could not be null!");
        }
        Request request = new Request.Builder().url(url).get().build();
    ...
    public String put(URL url, MediaType type, String body) throws IOException, IllegalStateException {
        if (null == url) {
            throw new NullPointerException("url could not be null!");
        }
    ...
    public String delete(URL url, MediaType type, @Nullable String body) throws IOException, IllegalStateException {
        if (null == url) {
            throw new NullPointerException("url could not be null!");
        }
    ...
    public String post(URL url, MediaType type, String body) throws IOException, IllegalStateException {
        if (null == url) {
            throw new NullPointerException("url could not be null!");
        }
     ...
     */
    public String post(URL url, MediaType type, File file) throws IOException, IllegalStateException {
        if (null == url) {
            throw new NullPointerException("url could not be null!");
        }
    ...
    public String post(URL url, Map<String, String> formParams) throws IOException, IllegalStateException {
        if (null == url) {
            throw new NullPointerException("url could not be null!");
        }
